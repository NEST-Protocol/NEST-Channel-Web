...
import type { NestGovernance, NestGovernanceInterface } from '../NestGovernance'
...
export class NestGovernance__factory {
  static readonly abi = _abi
  static createInterface(): NestGovernanceInterface {
    return new utils.Interface(_abi) as NestGovernanceInterface
  }
  static connect(address: string, signerOrProvider: Signer | Provider): NestGovernance {
    return new Contract(address, _abi, signerOrProvider) as NestGovernance
  }
}
