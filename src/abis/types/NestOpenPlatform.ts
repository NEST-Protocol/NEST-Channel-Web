...
export interface NestOpenPlatformInterface extends utils.Interface {
  ...
  encodeFunctionData(functionFragment: 'changeOpener', values: [BigNumberish, string]): string
  ...
  encodeFunctionData(functionFragment: 'findPriceOld', values: [BigNumberish, BigNumberish, BigNumberish]): string
  ...
  decodeFunctionResult(functionFragment: 'changeOpener', data: BytesLike): Result
  ...
  decodeFunctionResult(functionFragment: 'findPriceOld', data: BytesLike): Result
...
export interface NestOpenPlatform extends BaseContract {
  ...
  callStatic: {
    ...
    changeOpener(channelId: BigNumberish, newOpener: string, overrides?: CallOverrides): Promise<void>
