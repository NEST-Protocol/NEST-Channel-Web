...
export type PairViewStruct = { target: string; sheetCount: BigNumberish }

export type PairViewStructOutput = [string, BigNumber] & {
  target: string
...
export type ChannelConfigStructOutput = [string, BigNumber, string, BigNumber, number, number, number, string[]] & {
  token0: string
  unit: BigNumber
  reward: string
  rewardPerBlock: BigNumber
...
export interface NestBatchPlatform2Interface extends utils.Interface {
  functions: {
  ...
  encodeFunctionData(functionFragment: 'addPair', values: [BigNumberish, string]): string
  ...
  encodeFunctionData(functionFragment: 'open', values: [ChannelConfigStruct]): string
  ...
  encodeFunctionData(functionFragment: 'triggeredPrice', values: [BigNumberish, BigNumberish[], string]): string
  encodeFunctionData(functionFragment: 'triggeredPriceInfo', values: [BigNumberish, BigNumberish]): string
...
export interface NestBatchPlatform2 extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this
  attach(addressOrName: string): this
  deployed(): Promise<this>

  interface: NestBatchPlatform2Interface
  ...
  callStatic: {
    ...
    addPair(channelId: BigNumberish, target: string, overrides?: CallOverrides): Promise<void>
    ...
    open(config: ChannelConfigStruct, overrides?: CallOverrides): Promise<void>
  ...
  filters: {
    'Open(uint256,address,uint256,address)'(
      channelId?: null,
      token0?: null,
      unit?: null,
      reward?: null
    ): OpenEventFilter
    Open(channelId?: null, token0?: null, unit?: null, reward?: null): OpenEventFilter

    'Post(uint256,uint256,address,uint256,uint256,uint256)'(
      channelId?: null,
      pairIndex?: null,
      miner?: null,
      index?: null,
    ...
    Post(channelId?: null, pairIndex?: null, miner?: null, index?: null, scale?: null, price?: null): PostEventFilter
  }
  ...
  estimateGas: {
    ...
    open(config: ChannelConfigStruct, overrides?: Overrides & { from?: string | Promise<string> }): Promise<BigNumber>
